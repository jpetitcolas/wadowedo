...
function handleTribeName() {
    ...
    $('#chat-tabs a:eq(2)')[player.isChief || player.isSubChief ? 'show' : 'hide']();
}
...
socket.on('validateCrafting', function(craftData) {
    ...
    message += '<br /> Construire <span class="' + craftData.type + '"><a href="' + craftData.itemName + '">' + craftData.itemLabel + '</a></span></p>';
