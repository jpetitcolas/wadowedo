...
module.exports = function() {
    ...
    hub.sendInitialData = function(player) {
        ...
        player.socket.emit('updateTribe', {tribeName: player.tribeName, isChief: player.isChief, isSubChief: player.isSubChief});
    ...
    hub.createTribe = function(tribeName, player) {
        if (tribeName in hub.tribes) {
            return player.socket.emit('createTribeResult', {message: 'Cette tribu exists déjà', status:'error'});
        }
