...
module.exports = function(eventEngine) {
    ...
    hub.sendInitialData = function(player) {
        ...
        player.socket.emit('updateResources', player.tribe.resources);
        player.socket.emit('updateInventory', player.tribe.inventory);
        player.socket.emit('updateSkills', player.skills);
        player.socket.emit('tribeList', hub.getTribesWithPlayerNames());
        player.socket.emit('allClickCount', player.tribe.getAllCraftingClicks());
